...
export const metadata: Metadata = {
  title: '자주 묻는 질문 | 울산광역시 생활 정보통',
  description:
    '울산 시민이 자주 찾는 생활·복지·교통·지원금 정보를 한곳에 모은 FAQ 페이지입니다.',
};
...
export default function QnaBoard() {
  return (
    <main className="min-h-screen bg-[#F5F7FA] text-[#1F2937] font-sans pb-24 selection:bg-[#C9A857]/30">
      ...
      <div className="max-w-5xl mx-auto px-6 mt-12 flex flex-col gap-8">
        ...
        <section className="bg-[#0F1A2B] text-white rounded-2xl p-6 md:p-8 border border-[#C9A857]/20 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
            <div>
              ...
              <p className="text-slate-300 break-keep leading-relaxed">
                빠른 답변을 위해 이메일로 문의해 주시면 확인 후 안내해 드립니다.
              </p>
            </div>
