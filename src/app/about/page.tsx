...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#F5F7FA] text-[#1F2937] font-sans selection:bg-[#C9A857]/30 pb-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-[#0F1A2B] text-white py-20 px-6 border-b-[4px] border-[#C9A857]">
        <div className="absolute top-1/4 -right-20 w-96 h-96 bg-[#C9A857]/10 rounded-full blur-[100px] pointer-events-none"></div>
        <div className="max-w-4xl mx-auto w-full text-center relative z-10 flex flex-col items-center gap-6">
          ...
          <p className="text-slate-300 text-[18px] md:text-[20px] font-medium max-w-2xl mt-2 leading-relaxed break-keep">
            울산 365 포털에서 내 일상에 꼭 필요한 생활 정보를 놓치지 마세요.
          </p>
        </div>
      </section>

      {/* Content Section */}
      <section className="max-w-4xl mx-auto px-6 mt-16 flex flex-col gap-12">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border-[2px] border-[#0F1A2B]">
          ...
          <div className="space-y-6 text-[16px] md:text-[18px] text-slate-600 leading-loose break-keep">
            <p>
              안녕하세요! <strong>울산 365</strong>는 울산광역시 시민들의 더 나은 일상을 위해 만들어진 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-8 shadow-sm border-[2px] border-slate-200 text-center hover:border-[#0F1A2B] hover:-translate-y-1 transition-all">
